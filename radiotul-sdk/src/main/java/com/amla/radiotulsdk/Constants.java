...
public class Constants {
    ...
    public static final String EDIT_PROFILE_API = BASE_MOBILE_API_URL + "/EditarPerfil";
    public static final String GET_COMPANY_DATA_API = BASE_MOBILE_API_URL + "/GetDatosEmpresa";
